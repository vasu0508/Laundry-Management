...
public class EditLaundryActivity extends AppCompatActivity {
...
//                Intent intent2 = new Intent(EditLaundryActivity.this, SearchUserActivity.class);
//                startActivity(intent2);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Toast.makeText(EditLaundryActivity.this, "Total Amount: "+totalcost.toString()+"\n"+"Total Clothes: "+totalclothes.toString(), Toast.LENGTH_SHORT).show();
                ...
                if(Double.parseDouble(totalcost.toString()) <= Double.parseDouble(balance.toString())) {
                    ...
                    Toast.makeText(EditLaundryActivity.this, "Insufficient Balance", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void readDataFromGoogleSheet() {
        ...
        call.enqueue(new Callback<ValueRange>() {
            ...
            public void onResponse(@NonNull Call<ValueRange> call, @NonNull Response<ValueRange> response) {
                ...
                customAdapter2 = new CustomAdapter3(EditLaundryActivity.this, R.layout.addlaundrylistview, a,a.size());
                ls.setAdapter(customAdapter2);
                ...
                if (a.size() == 1) {
                    ...
                    customAdapter2 = new CustomAdapter3(EditLaundryActivity.this, R.layout.addlaundrylistview, d,d.size());
                    ls.setAdapter(customAdapter2);
...
//                }
            ...
            public void onFailure(@NonNull Call<ValueRange> call, @NonNull Throwable t) {
                Toast.makeText(EditLaundryActivity.this, "Unable to fetch data", Toast.LENGTH_SHORT).show();
                ArrayList<pricelistclass> e = new ArrayList<pricelistclass>();
                e.add(new pricelistclass("No Internet Connection", "", ""));
                customAdapter2 = new CustomAdapter3(EditLaundryActivity.this, R.layout.addlaundrylistview, e,e.size());
                ls.setAdapter(customAdapter2);
                ls.setClickable(false);
                // Handle error
            }
